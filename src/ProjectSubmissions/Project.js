...
function Projects() {
  ...
  useEffect(() => {
    axios.get("http://localhost:4001/progress_history").then((response) => {
      setProject(response.data)
    })
  }, [])

  useEffect(() => {
    axios.get("http://localhost:4001/help_requests").then((response) => {
    ...
    <div className={classes.root}>
      <Container classes={{ root: styles.background }} maxWidth="xl">
        ...
        <div id="button_group">
          <Button
            id="button1"
            classes={{ root: styles.button1, text: styles.button1 }}
            size="small"
            variant="contained"
          >
            Take Screenshot
          </Button>
          <Button id="button2" classes={{ root: styles.button2 }} size="small" variant="contained">
            Help Centre
          </Button>
          <Button id="button3" classes={{ root: styles.button3 }} size="small" variant="contained">
            More Projects
          </Button>
        </div>
                  ...
                  <div id="innercard">
                    ...
                    <div id="subname">
                      <div className="subcontent">
                        <h2>{users.first_name.toUpperCase()} submitted their project</h2>
                      </div>
              ...
              <div id="content1">
                ...
                <Card classes={{ root: styles.cards }} elevation={3}>
                  <div id="innercard">
                    ...
                    <div id="helpname">
                      <div>
                        <h2>{users.first_name.toUpperCase()} wants to show you their project</h2>
                      </div>
                    </div>
