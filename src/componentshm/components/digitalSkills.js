        ...
        <Container maxWidth="xl">
            <div className="digitalSkills">
                <div className="digitalSkillsText">
                    <h3>Teaching kids programming and digital skills is MORE than just writing code.</h3></div>
